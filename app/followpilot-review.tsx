      ...
      <section className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-md items-center px-5 py-12">
        <div className="w-full">
          ...
          <form key={mode} onSubmit={submit} className="mt-8 space-y-4">
            {signingUp && <label className="block text-sm font-medium">Your name<input name="name" required placeholder="Your name" className="mt-2 w-full rounded-lg border border-[#deddda] bg-white px-3 py-2.5 text-sm outline-none transition placeholder:text-[#9b9995] focus:border-[#191919] focus:ring-3 focus:ring-[#e9e9e7]" /></label>}
            ...
            {signingUp && <label className="block text-sm font-medium">Workspace name<input required placeholder="Acme sales" className="mt-2 w-full rounded-lg border border-[#deddda] bg-white px-3 py-2.5 text-sm outline-none transition placeholder:text-[#9b9995] focus:border-[#191919] focus:ring-3 focus:ring-[#e9e9e7]" /></label>}
            ...
            <button type="submit" disabled={isSubmitting || !firebaseIsConfigured()} className="mt-2 flex w-full items-center justify-center rounded-lg bg-[#191919] px-4 py-2.5 text-sm font-medium text-white transition hover:bg-[#353535] focus:outline-none focus:ring-3 focus:ring-[#d9d9d7] disabled:opacity-45">{isSubmitting ? "Please wait…" : signingUp ? "Create workspace" : "Sign in"}</button>
          </form>
          ...
          <button type="button" onClick={() => void continueWithGoogle()} disabled={isSubmitting || !firebaseIsConfigured()} className="flex w-full items-center justify-center gap-2 rounded-lg border border-[#deddda] bg-white px-4 py-2.5 text-sm font-medium transition hover:bg-[#f7f7f5] focus:outline-none focus:ring-3 focus:ring-[#e9e9e7] disabled:opacity-45"><GoogleIcon /> Continue with Google</button>
...
function UploadModal({
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-end bg-black/20 p-0 sm:items-center sm:justify-center sm:p-6 ${isClosing ? "modal-backdrop-exit pointer-events-none" : "modal-backdrop-enter"}`} role="presentation" onMouseDown={requestClose}>
      <section role="dialog" aria-modal="true" aria-labelledby="upload-title" className={`max-h-[94vh] w-full max-w-2xl overflow-y-auto rounded-t-xl bg-white shadow-[0_1px_2px_rgba(0,0,0,0.03)] sm:rounded-xl ${isClosing ? "modal-panel-exit" : "modal-panel-enter"}`} onMouseDown={(event) => event.stopPropagation()}>
        ...
        <footer className="flex flex-col-reverse gap-3 border-t border-[#ececea] px-6 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-8"><p className="text-xs text-[#787774]">Approved updates go to this HubSpot deal.</p><div className="flex gap-2"><button type="button" onClick={requestClose} disabled={isAnalyzing} className="rounded-md px-4 py-2.5 text-sm font-medium text-[#625f5c] transition hover:bg-[#f2f2f0] disabled:opacity-45">Cancel</button><button type="button" onClick={onAnalyze} disabled={!transcript.trim() || !authorized || !matchedContact || !selectedDealId || isAnalyzing} className="inline-flex items-center justify-center gap-2 rounded-md bg-[#191919] px-4 py-2.5 text-sm font-medium text-white transition hover:bg-[#353535] focus:outline-none focus:ring-3 focus:ring-[#d9d9d7] disabled:cursor-not-allowed disabled:opacity-45"><SparkIcon /> {isAnalyzing ? "Analyzing…" : "Analyze now"}</button></div></footer>
      </section>
    </div>
  );
}
          ...
          return (
            ...
            >
              <button
                ...
                className={cx(
                  "group w-full text-left outline-none focus-visible:ring-3 focus-visible:ring-[#e9e9e7] disabled:cursor-not-allowed",
                ...
                <div className="mt-2">
                  ...
                  <div className="mt-3 flex gap-2">
                    <button
                      ...
                      className="rounded-lg bg-[#191919] px-3 py-2 text-xs font-semibold text-white hover:bg-[#353535] disabled:opacity-45"
                    >
                      Save edited value
                    </button>
                    <button
    ...
    <AppShell onNewMeeting={() => hubSpotConnection.connected ? setUploadOpen(true) : router.push("/onboarding")}>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
            ...
            <aside className="h-fit rounded-xl border border-[#deddda] bg-white p-5 sm:p-6 lg:sticky lg:top-6">
              ...
              <button
                ...
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-md bg-[#191919] px-4 py-3 text-sm font-medium text-white hover:bg-[#353535] focus:ring-3 focus:ring-[#d9d9d7] disabled:opacity-45"
              >
        ...
        <div className="mx-auto max-w-[1480px] px-4 py-8 sm:px-6 lg:px-8">
          <div className="grid gap-7 lg:grid-cols-[260px_minmax(0,1fr)]">
            ...
            <div>
                ...
                {manualOpen && (
                  <div className="mt-5 grid gap-4 border-t border-slate-100 pt-5 sm:grid-cols-2">
                    ...
                    <button
                      ...
                      className="w-fit rounded-lg bg-slate-950 px-4 py-2.5 text-sm font-semibold text-white hover:bg-slate-800 disabled:opacity-45 sm:col-span-2"
                    >
                      Add manual change
                    </button>
                  </div>
              ...
              <div className="sticky bottom-4 mt-6 flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-[0_1px_2px_rgba(0,0,0,0.03)] backdrop-blur sm:flex-row sm:items-center sm:justify-between">
                <div>
                ...
                <button
                  ...
                  className="google-border-action rounded-md px-5 py-3 text-sm font-medium text-white disabled:opacity-45"
                >
      ...
      {step === "summary" && (
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          ...
          <section className="mt-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
          ...
          <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-between">
            ...
            <button
              ...
              disabled={isApplying}
              className="rounded-md bg-[#191919] px-5 py-3 text-sm font-medium text-white hover:bg-[#353535] focus:ring-3 focus:ring-[#d9d9d7]"
            >
